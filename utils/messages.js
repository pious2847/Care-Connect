...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #fff; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin: 20px 0;">
        ...
        <ol style="padding-left: 20px;">
            <li><strong>Access the Portal:</strong> Visit <a href="https://care-cycle.onrender.com/login" style="color: #2563eb;">https://care-cycle.onrender.com/login</a></li>
            ...
            <tr>
                <td style="text-align: center;">
                    ...
                    <p style="color: #6b7280; font-size: 0.8em;">
                        ...
                        <a href="https://care-cycle.onrender.com/login" style="color: #2563eb; text-decoration: none;">www.careconnect.com</a>
                    </p>
                </td>
            </tr>
        </table>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #fff; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin: 20px 0;">
        ...
        <ol style="padding-left: 20px;">
            ...
            <li><strong>Access Dashboard:</strong> Visit <a href="https://care-cycle.onrender.com/login" style="color: #2563eb;">https://care-cycle.onrender.com/login</a></li>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #f3f4f6; border-radius: 8px; padding: 20px; margin: 20px 0;">
        ...
        <p><strong>Meeting Room:</strong> https://care-cycle.onrender.com/room/${appointment._id} </p>
    </div>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #f3f4f6; border-radius: 8px; padding: 20px; margin: 20px 0;">
        ...
        <p><strong>Appointment Time:</strong> ${appointment.time}</p>
        <p><strong>Reason for Visit:</strong> ${appointment.message}</p>
        <p><strong>Meeting Room:</strong> <a href="https://care-cycle.onrender.com/room/${appointment._id}">Join Meeting</a></p>
    </div>
